...
def main():
    ...
    artists = pd.read_csv("etl/data/artists.csv")
    albums = pd.read_csv("etl/data/albums.csv")
    tracks = pd.read_csv("etl/data/tracks.csv")
    track_features = pd.read_csv("etl/data/track_features.csv")
